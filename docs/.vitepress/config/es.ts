export default {
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Plugins', link: '/es/plugins/cors' }
    ],
    socialLinks: [
    ...
    sidebar: [
      ...
      },
      {
        text: 'Plugins',
        items: [
          { text: 'CORS', link: '/es/plugins/cors' },
          { text: 'Rate Limiting', link: '/es/plugins/rate-limit' },
          { text: 'Validación', link: '/es/plugins/validation' }
        ]
      }
    ]
  }
